...
from smartcalserver.caldav.mkcol import HandleMkCol

def test_InstantiateHandleMkCol():
	HandleMkCol_instance = HandleMkCol()
	assert HandleMkCol_instance is not None
