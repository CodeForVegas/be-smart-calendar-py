...
from smartcalserver.caldav.propfind import HandlePropFind

def test_InstantiateHandlePropFind():
	HandlePropFind_instance = HandlePropFind()
	assert HandlePropFind_instance is not None
