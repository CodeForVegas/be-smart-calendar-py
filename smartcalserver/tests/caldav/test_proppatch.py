...
from smartcalserver.caldav.proppatch import HandlePropPatch

def test_InstantiateHandlePropPatch():
	HandlePropPatch_instance = HandlePropPatch()
	assert HandlePropPatch_instance is not None
