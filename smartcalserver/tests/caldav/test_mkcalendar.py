...
from smartcalserver.caldav.mkcalendar import HandleMkCalendar

def test_InstantiateHandleMkCalendar():
	HandleMkCalendar_instance = HandleMkCalendar()
	assert HandleMkCalendar_instance is not None
