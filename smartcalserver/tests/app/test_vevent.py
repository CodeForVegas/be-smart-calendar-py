...
from smartcalserver.app.vevent import EventForeignData, EventData, Event
import pytest
...
def test_instantiateEventData():
	...
	assert eventdata_instance is not None

def test_instantiateEvent():
	event_instance = Event()
	assert event_instance is not None
