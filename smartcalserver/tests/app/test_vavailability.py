...
from smartcalserver.app.vavailability import AvailabilityForeignData, AvailabilityData, Availability
import pytest
...
def test_instantiateAvailabilityData():
	...
	assert availabilitydata_instance is not None

def test_instantiateAvailability():
	availability_instance = Availability()
	assert availability_instance is not None
